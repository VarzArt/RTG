const link = "http://api.weatherstack.com/current?access_key=1a2790bd55c629f218bcd941e32ada55";
	...
	return Object.values(properties).map(({title, value, icon}) => {
		return `<div class="property">
						<div class="property-icon">
							<img src="/assets/images/moscow_page/weather_app/properties/${icon}" alt="">
						</div>
...
const markUp = () => {
	...
	return `<div class="container ${containerClass}">
					<div class="top">
						...
						<div class="city-info">
							<div class="top-left">
							<img class="icon" src="/assets/images/moscow_page/weather_app/state/${getImage(description)}" alt="" />
